package com.spring6restmvc.model;
...
public class Beer {
    ...
    Beer(UUID id, Integer version, String beerName, BeerStyle beerStyle, String upc, Integer qualityOnHand, BigDecimal price, LocalDateTime createdDate, LocalDateTime updateDate) {
        this.id = id;
    ...
    public Integer getQualityOnHand() {
        return this.qualityOnHand;
    }
    ...
    public void setQualityOnHand(Integer qualityOnHand) {
        this.qualityOnHand = qualityOnHand;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$qualityOnHand = this.getQualityOnHand();
        final Object other$qualityOnHand = other.getQualityOnHand();
        if (this$qualityOnHand == null ? other$qualityOnHand != null : !this$qualityOnHand.equals(other$qualityOnHand))
            return false;
    ...
    public int hashCode() {
        ...
        final Object $qualityOnHand = this.getQualityOnHand();
        result = result * PRIME + ($qualityOnHand == null ? 43 : $qualityOnHand.hashCode());
    ...
    public String toString() {
        return "Beer(id=" + this.getId() + ", version=" + this.getVersion() + ", beerName=" + this.getBeerName() + ", beerStyle=" + this.getBeerStyle() + ", upc=" + this.getUpc() + ", qualityOnHand=" + this.getQualityOnHand() + ", price=" + this.getPrice() + ", createdDate=" + this.getCreatedDate() + ", updateDate=" + this.getUpdateDate() + ")";
    }
    ...
    public static class BeerBuilder {
        ...
        public BeerBuilder qualityOnHand(Integer qualityOnHand) {
            this.qualityOnHand = qualityOnHand;
            return this;
        }
        ...
        public Beer build() {
            return new Beer(this.id, this.version, this.beerName, this.beerStyle, this.upc, this.qualityOnHand, this.price, this.createdDate, this.updateDate);
        }

        public String toString() {
            return "Beer.BeerBuilder(id=" + this.id + ", version=" + this.version + ", beerName=" + this.beerName + ", beerStyle=" + this.beerStyle + ", upc=" + this.upc + ", qualityOnHand=" + this.qualityOnHand + ", price=" + this.price + ", createdDate=" + this.createdDate + ", updateDate=" + this.updateDate + ")";
        }
    }
}
